		...
		public static async Task SeedDataAsync(IdentityModuleDbContext context)
		{
			...
			if (!context.Users.Any())
			{
				var user = new AppUser
				{
					...
					PhoneNumber = "0822841004",
					UserName = "khangbnps34729@fpt.edu.vn",
					Email = "khangbnps34729@fpt.edu.vn",
					NormalizedUserName = "KHANGBNPS34729@FPT.EDU.VN",
					NormalizedEmail = "KHANGBNPS34729@FPT.EDU.VN",
